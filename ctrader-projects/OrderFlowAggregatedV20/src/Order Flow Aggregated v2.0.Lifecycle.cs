    ...
    public partial class OrderFlowTicksV20 : Indicator
    {
        ...
        private void ExportEvent(ButtonClickEventArgs obj)
        {
            ...
            try
            {
                ...
                Print("Starting Order Flow History Export...");
                ClearAndRecalculate();
                Print("Order Flow History Export Finished.");
            }
            catch (Exception ex)
            {
        ...
        private void AppendDirectHistoryJsonl(Dictionary<string, object> exportData)
        {
            ...
            string filePath = Path.Combine(outputFolder, $"history_orderflowaggregated_{symbol}.jsonl");
